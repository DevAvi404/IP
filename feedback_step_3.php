...
if (empty($_SESSION['faculty_id']) || empty($_SESSION['name']) || empty($_SESSION['subject'])) {
...
// Fetch questions
$stmt = mysqli_prepare($al, "SELECT * FROM questions WHERE id = ?");
...
<head>
    ...
    <title>Feedback Step 4 - Student Feedback System</title>
    ...
    <div class="container">
        ...
        <main class="content">
            <div class="page-header">
                <h2 class="page-title">Provide Feedback</h2>
                <p class="page-subtitle">Rate the faculty on the following criteria (1 = Poor, 5 = Excellent)</p>
            </div>

            <div class="card">
                <form method="post" action="feedback_step_4.php" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label>Roll Number</label>
                        <input type="text" class="form-input" value="<?php echo htmlspecialchars($student_id); ?>" disabled>
                        <input type="hidden" name="roll" value="<?php echo htmlspecialchars($student_id); ?>">
                    </div>
                    ...
                    <?php for ($i = 1; $i <= 10; $i++) { ?>
                        <div class="form-group">
                            <label><?php echo htmlspecialchars($q['q' . $i]); ?></label>
                            <div class="rating-group">
                                <?php for ($j = 1; $j <= 5; $j++) { ?>
                                    <label>
                                        <input type="radio" name="q<?php echo $i; ?>" value="<?php echo $j; ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comment" class="form-textarea" placeholder="Enter any additional feedback (optional)"></textarea>
                    </div>

                    <div class="btn-group">
                        <button type="button" class="btn btn-secondary" onclick="window.location='feedback_step_2.php'">
